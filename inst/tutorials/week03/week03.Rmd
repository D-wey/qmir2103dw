...
## Data
#load("df_learnr03_ep_elections.rda") # for local testing
...
The data set for this exercise (`ep_elections`) contains information on voter turnout and the number of total votes cast in elections to the European Parliament.
...
```{r encode, echo=FALSE}
learnrhash::encoder_ui(default_ui(url = "https://ilias.uni-mannheim.de/ilias.php?baseClass=ilObjSurveyGUI&ref_id=1114107&cmd=infoScreen"))
```
